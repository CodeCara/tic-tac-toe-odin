  ...
  //Should value below be left as null?
   ...
   let score = 0;
    ...
    let displayController = function(){
        ...
        if (currentPLayer='Player One'){gameboard.board[displayController.squareClicked]='X'} else {gameboard.board[displayController.squareClicked]='0'};
...
currentPLayer=currentPLayer==='Player One'? currentPLayer='Player Two': currentPLayer = 'Player One';
console.log(currentPLayer);
